...
public class EjemploParamsController {
	...
	@GetMapping("/string")
	public String param(@RequestParam(value = "texto", required = false, defaultValue = "Algún valor...") String texto,
			Model model) {
	...
	public String mixParamsHttpServlet(HttpServletRequest request, Model model) {
